			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <span class="ui-form-required"> *</span>
                        <div class="col-sm-5">
                            <input  id="propath" name="propath" type="text" value="" class="form-control" placeholder="E:\ideaWorkspace\pack">
                        </div>
                    </div>
					...
					<div class="form-group">
                        ...
                        <span class="ui-form-required"> *</span>
						<div class="col-sm-5">
							<input  id="packtime" name="packtime" type="text" value="" class="form-control" onclick='WdatePicker({dateFmt:"yyyy-MM-dd HH:mm:ss"})' >
						</div>
