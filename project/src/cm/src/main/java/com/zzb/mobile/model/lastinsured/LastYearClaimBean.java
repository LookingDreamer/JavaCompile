...
public class LastYearClaimBean implements Serializable{
	...
	JSONArray syclaims;//商业险事故
	JSONArray jqclaims;//交强险事故
	
	public JSONArray getSyclaims() {
		return syclaims;
	}
	public void setSyclaims(JSONArray syclaims) {
		this.syclaims = syclaims;
	}
	public JSONArray getJqclaims() {
		return jqclaims;
	}
	public void setJqclaims(JSONArray jqclaims) {
