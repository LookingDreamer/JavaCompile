...
public class INSBCarinfo extends BaseEntity implements Identifiable {
	...
	public String getPaidtaxes() {
		return paidtaxes;
	}

	public void setPaidtaxes(String paidtaxes) {
