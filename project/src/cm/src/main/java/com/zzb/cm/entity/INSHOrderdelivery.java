...
public class INSHOrderdelivery extends BaseEntity implements Identifiable {
	 ...
	 * 配送地址表id
	 */
	private String insborderdelivery;
	...
	public String getInsborderdelivery() {
		return insborderdelivery;
	}

	public void setInsborderdelivery(String insborderdelivery) {
