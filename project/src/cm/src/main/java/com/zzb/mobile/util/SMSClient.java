...
public class SMSClient {
	...
	private String serviceURL = "";// 接口调用地址
	private String sn = "";// 软件序列号
	private String pwd = "";// 密码

	/*
	 * 构造函数
	 */
	public SMSClient(String url, String sn, String pwd) throws UnsupportedEncodingException {
		this.serviceURL = url;
		this.sn = sn;
		//密码为md5(sn+pwd)
		this.pwd = this.getMD5(sn + pwd);
	}

	public static void SendMsg(String url, String sn, String pwd, String msg, String phonenum, String code) 
			throws Exception {
		SMSClient client;
		try {
			client = new SMSClient(url,sn,pwd);
			msg = msg.replace("{code}", code);
			System.out.println("phonenum:" + phonenum +",msg:" + msg);
			String content = java.net.URLEncoder.encode(msg, "utf-8");  
			String result_mt = client.mdsmssend(phonenum, content, "", "", "", "");
			System.out.println("result:" + result_mt);
			if(result_mt.startsWith("-")){
	        	throw new Exception("短信发送失败" + result_mt);
	        }
	...
	public static void SendMsg(String url, String sn, String pwd, String msg, String phonenum, 
	 ...
	 * 方法名称：mdgetSninfo 
	 * 功    能：获取信息
	 * 参    数：sn,pwd(软件序列号，加密密码md5(sn+pwd))
	 * 
	 */
