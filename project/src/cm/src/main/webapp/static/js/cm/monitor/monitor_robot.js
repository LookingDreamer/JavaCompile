...
//			    alert("Select value: "+option.attr('rolename'));
		...
		$('#table-javascript').bootstrapTable({
            method: 'get',
            url: "query?quotetype="+$("#quotetype").val(),
            cache: false,
            striped: true,
            pagination: true,
		...
		$('#table-javascript-1').bootstrapTable({
            method: 'get',
            url: "robottaskinfo?monitoeid="+$("#monitoeid").val(),
            cache: false,
            striped: true,
            pagination: true,
            sidePagination: 'server', 
		...
		$("#querybuttonInfo").on("click", function(e) {
			...
			var tageturl = 'robottaskinfo?monitoeid='+$("#monitoeid").val();
		...
		$("#all").on("click", function(e) {
			var tageturl = 'robottaskinfo?monitoeid='+$("#monitoeid").val() + "&todayflag=true";
			$("#taskid").val("");
			$("#plateno").val("");
			$("#carowername").val("");
...
function viewInfo(id,orgcode){
	location.href = "robotinfo?id=" + id + "&orgcode=" + orgcode;
}
