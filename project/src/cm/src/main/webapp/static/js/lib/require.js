...
(function (global) {
    ...
    if (isBrowser && !cfg.skipDataMain) {
        ...
        eachReverse(scripts(), function (script) {
            ...
            // Look for a data-ver
            jsver = script.getAttribute('data-ver');
            if (jsver) {
            	cfg.urlArgs = 'ver=' + jsver;
            }else {
            	jsver = '0.0.0';
            }
...
requirejs.config({
	"paths" : {
		...
		"zTreeexhide":"lib/zTree/js/jquery.ztree.exhide-3.5",
	...
	"shim" : {
		...
		"bootstrapTableZhCn" : ["bootstrap-table"],
		"fileinput" : ["jquery"],
		...
		"zTreeexedit" : ["jquery", "zTree"],
		"zTreeexhide" : ["jquery", "zTree"],
		"public" : ["jquery"],
		"core" : ["jquery", "jqblockui"],
		"ajaxfileupload" : ["jquery"],
		"jsoneditor" : ["jquery"],
        "bootstrap-table-export": ["jquery", "bootstrap-table"],
        "tableExport": ["jquery"]
	}
});