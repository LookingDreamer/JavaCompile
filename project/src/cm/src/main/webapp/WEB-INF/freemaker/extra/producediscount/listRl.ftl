...
<title>供应商优惠设置管理</title>
<link href="${staticRoot}/css/appmodule.css" rel="stylesheet">
<script data-ver="${jsver}" data-main="${staticRoot}/js/load" src="${staticRoot}/js/lib/require.js?ver=${jsver}"></script>
<script type="text/javascript">
		requirejs([ "zzbconf/producediscountrl" ]);
</script>
<body>
			...
			<div class="col-md-12">
				<form role="form" id="policymanagent">
					<div class="form-group form-inline col-md-4">
						<label for="exampleInputCode">供应商名称</label> 
			...
			<form id="form1" action="save" method="post">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>
					 ...
					 <tr>
						 <td>供应商名称</td>
						 <td>	<select id="companyno" name="companyno">
						<#list alist as alist>
						 <option value ="${alist.value}">${alist.text}</option>
						</#list>
						</select></td>
						...
						<tr>
						 <td>产品优惠名称</td>
						 <td>	<select id="discountid" name="discountid">
						<#list plist as plist>
