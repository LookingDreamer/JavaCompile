...
<form action="/cm/report/showReport" name="fm1" method="post" id="fm1" target="report_frame">
	<div class="panel panel-default">
		<div class="panel-heading">交易清单</div>
		<div class="panel-body">
			<div class="row">
				...
				<div class="col-md-4">
					<label><font color="red">*</font>类型<label><select class="form-control m-left-5" id="comcode" name="column_name" placeholder="请选择">
					     <option value="1">已支付清单</option>
					     <option value="2">通过核保清单</option>
					</select>
				</div>
				<div class="col-md-4">
	...
	<input id="raq" name="raq" value="transactionList.raq" type="hidden">
</form>
<script>
    function doSearch(){
    	$.insLoading();
