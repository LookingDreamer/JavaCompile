...
<form action="/cm/report/showReport" name="fm1" method="post" id="fm1" target="report_frame">
	<div class="panel panel-default">
		<div class="panel-heading">代理人激活</div>
			...
			<div class="row">
				...
				<div class="col-md-4">
					...
					<div style="float:left;"
						...
						data-date-format="yyyy-mm-dd hh:ii:ss" data-link-field="startdate">
						<input class="form-control" style="color:black;" type="text" id="startdateTxt" readonly value=""/>
				...
				<div class="col-md-4">
					...
					<div style="float:left;"
						class="input-group date form_datetime col-sm-6"
						data-date-format="yyyy-mm-dd hh:ii:ss" data-link-field="enddate">
						<input class="form-control" style="color:black;" type="text" id="enddateTxt" readonly value=""/>
						<span class="input-group-addon"> 
							<span class="glyphicon glyphicon-remove"></span>
						</span> 
						<span class="input-group-addon"> 
	...
	<input id="raq" name="raq" value="activeUser.raq" type="hidden">
</form>
<script>
    function doSearch(){
