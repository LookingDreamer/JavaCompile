...
<script type="text/javascript">
		requirejs([ "zzbconf/producediscount" ]);
</script>
<body>
			...
			<div class="col-md-12">
				<form role="form" id="policymanagent">
					<div class="form-group form-inline col-md-4">
						<label for="exampleInputCode">优惠产品名称</label> <input type="text"
				...
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>
					 ...
					 <tr>
						 ...
						 <td>优惠产品类别</td><td><select id="type" name="type">
						 <option value ="1">产品优惠</option>
						  <option value ="2">产品优势</option>
						</select></td>
					 </tr>
						 <tr><td>优惠产品描述</td><td><input type="text" id="note" name="note" ></td>
					 </tr>
