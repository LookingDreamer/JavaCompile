...
<head>
	...
	<script type="text/javascript">
		requirejs([ "cm/common/editRelationPersonInfo" ],function() {
...
<form id="editRelationPersonInfoForm">
	...
	<input type="hidden" name="inscomcode" value="${relationPersonInfo.inscomcode}"/>
	<!-- 选项卡下标 -->
				...
				<div class="col-md-12">
					<table class="table table-bordered" style="margin-bottom:0px">
						...
						<tr style="display: none">
							<td>手机号码:</td>
							<td>
								<#--隐藏情况下不校验手机号码 class="form-control phone"为校验手机号码格式-->
                                <input class="form-control" type="text" id="insuredcellphone" name="insured.cellphone" value="${relationPersonInfo.insuredcellphone}"/>
							</td>
							<td>E-mail:</td>
							<td>
								<#--隐藏情况下不校验邮箱 class="form-control email"为校验邮箱格式-->
                                <input class="form-control" type="text" id="insuredemail" name="insured.email" value="${relationPersonInfo.insuredEmail}"/>
							</td>
						</tr>
					</table>
				</div>
				  	...
				  	<div id="form1">
						<table class="table table-bordered" style="margin-bottom:0px">
							...
							<tr style="display: none">
								...
								<td>
									<#--隐藏情况下不校验手机号码 class="form-control phone"为校验手机号码格式-->
                                    <input class="form-control" type="text" name="applicant.cellphone" value="${relationPersonInfo.applicantcellphone}"/>
								</td>
								<td>E-mail:</td>
								<td>
									<#--隐藏情况下不校验邮箱 class="form-control email"为校验邮箱格式-->
                                    <input class="form-control" type="text" name="applicant.email" value="${relationPersonInfo.applicantEmail}"/>
								</td>
							</tr>
						</table>
					 </div>
		 			...
		 			<div id="form3">
						<table class="table table-bordered" style="margin-bottom:0px">
							...
							<tr>
								<td>证件类型:</td>
								<td>
									<#--隐藏情况下不校验证件号码 class="form-control idcardtype"为校验证件号码格式-->
                                    <select class="form-control" name="personForRight.idcardtype" id="personForRightidcardtype">
										<#list relationPersonInfo.CertKindList as CertKinditem>
											<option value="${CertKinditem.codevalue}" 
							...
							<tr>
								...
								<td>
									<#--隐藏情况下不校验手机号码 class="form-control phone"为校验手机号码格式-->
                                    <input class="form-control" type="text" name="personForRight.cellphone" value="${relationPersonInfo.personForRightcellphone}"/>
								</td>
								<td>E-mail:</td>
								<td>
									<#--隐藏情况下不校验邮箱 class="form-control email"为校验邮箱格式-->
                                    <input class="form-control" type="text" name="personForRight.email" value="${relationPersonInfo.personForRightEmail}"/>
								</td>
							</tr>
						</table>
					</div>
				...
				<div class="col-md-12">
					<table class="table table-bordered" style="margin-bottom:0px">
						...
						<tr style="display: none">
							...
							<td>
								<#--隐藏情况下不校验手机号码 class="form-control phone"为校验手机号码格式-->
                                <input class="form-control" type="text" id="carOwnerInfocellphone" name="carOwnerInfo.cellphone" value="${relationPersonInfo.carownercellphone}"/>
							</td>
							<td>E-mail:</td>
							<td>
								<#--隐藏情况下不校验邮箱 class="form-control email"为校验邮箱格式-->
                                <input class="form-control" type="text" id="carOwnerInfoemail" name="carOwnerInfo.email" value="${relationPersonInfo.carownerEmail}"/>
							</td>
						</tr>
					</table>
				</div>
