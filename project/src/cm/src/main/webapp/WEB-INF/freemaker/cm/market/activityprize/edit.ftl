				 ...
				 <input type="hidden" id="id" name="id" value="${insbActivityinfo.id}">
					<div class="form-group form-inline col-md-4">
						<label for="exampleInputCode">活动名称</label> <input type="text"
							 id="name" name="name" value="${insbActivityinfo.name}">							
					</div>
					...
					<div class="form-group form-inline col-md-4">
						<label for="exampleInputName">活动限制</label> <input type="text"
						 id="limited" name="limited" value="${insbActivityinfo.limited}">
					</div>
					<div class="form-group form-inline col-md-4">
