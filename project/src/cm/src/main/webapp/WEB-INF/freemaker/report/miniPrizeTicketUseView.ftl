...
<form action="/cm/report/showReport" name="fm1" method="post" id="fm1" target="report_frame">
	...
	<input id="raq" name="raq" value="miniPrizeTicketUseView.raq" type="hidden">
</form>
<script>
    function doSearch(){
    	$.insLoading();
...
<iframe id="report_frame" name="report_frame" style="float:left;width:100%; border: none;"></iframe>
</body>
