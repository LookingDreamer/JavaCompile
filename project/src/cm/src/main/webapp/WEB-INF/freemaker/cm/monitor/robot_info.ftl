...
<script type="text/javascript">
		requirejs([ "cm/monitor/monitor_robot" ]);
</script>
<body> 
	...
	<div class="container-fluid">
		<div class="panel panel-default m-bottom-5">
			<div class="panel-heading padding-5-5">精灵基本信息</div>
			<div class="row">
				<div class="col-md-12">
					<table class="table">
						<tr>
							<td style="vertical-align: middle;" class="col-md-2 active"><label
								for="exampleInputName">精灵名称</label></td>
							<td class="col-md-10" colspan="3"><input
								class="form-control" type="text" id="elfname" name="elfname"
								value="${elfconf.elfname!'' }" disabled="disabled"> <input
								type="hidden" id="elfconfid" name="elfid"
								value="${elfconf.id!'' }" disabled="disabled"></td>
						</tr>
						<tr>
							<td style="vertical-align: middle;" class="col-md-2 active"><label
							...
							<td class="col-md-10"><#list capacityconf as capconf>
								...
								"${elfconf.capacityconf }"?contains("${capconf.codevalue}")
						...
						<td class="col-md-10"><input class="form-control" type="text"
							id="elfpath" name="elfpath" value="${elfconf.elfpath!'' }"
		...
		<div class="panel panel-default m-bottom-5">
			<div class="panel-heading padding-5-5">当前精灵任务处理概况</div>
			<div class="row">
				<div class="col-md-12">
		...
		<div class="panel panel-default m-bottom-5">
			<div class="panel-heading padding-5-5">精灵查询(仅支持精确查询)</div>
