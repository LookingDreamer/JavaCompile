			...
			<div class="col-md-12">
				<form role="form" id="userform">					
					...
					<div class="form-group col-md-5 form-inline">
						<label for="exampleInputCode">任务跟踪号/支付号：</label> <input type="text"
							class="form-control" id="taskid" name="taskid" placeholder="">
					</div>
					<div class="form-group col-md-3 form-inline">
						<label for="exampleInputOrgName">选择类型：</label> 
						<select name="firoredi" class="form-control" id="firoredi">
						<option value="">请选择</option>
						<option value="0">精灵</option>
						<option value="1">EDI</option>
						<option value="2">支付</option>
						<option value="4">规则</option>
						<option value="5">核心保单同步</option>
						</select>
					</div>
					<div class="form-group col-md-4 form-inline">
						<label for="exampleInputCode">任务状态：</label> 
						<select name="flowcode" class="form-control" id="flowcode">
