...
<form action="/cm/report/showReport" name="fm1" method="post" id="fm1" target="report_frame">
	<div class="panel panel-default">
		<div class="panel-heading">时效清单</div>
		<div class="panel-body">
			<div class="row">
                ...
                <div class="col-md-4">
                    <label><font color="red">*</font>流程分类<label><select class="form-control m-left-5" id="tasktype" name="tasktype" placeholder="请选择">
                        <option value="0">全部</option>
                        <option value="1">人工流程</option>
                        <option value="2">自动化流程</option>
                        <option value="3">代理人操作流程</option>
                        <option value="4">二次支付任务</option>
                    </select>
                </div>
				<div class="col-md-4">
	...
	<input id="raq" name="raq" value="processEfficiency.raq" type="hidden">
</form>
<script>
    function doSearch(){
