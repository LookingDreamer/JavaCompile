...
<html>
	<head>
		...
		<script type="text/javascript">
			requirejs([ "cm/common/editCarInfo" ],function() {
	...
	<body>
		...
		<form class="form-inline" role="form" id="editCarinfo">
			...
			<div class="modal-header">
				...
				<h6 class="modal-title">修改车辆信息</h6>
			</div>
					...
					<div class="row">
						<div class="col-md-12">
							<table class="table table-bordered" id="insurancecarmessage" style="margin-bottom:0px">
								...
								<tr id="transferdateBox" <#if carInfo.isTransfercar == "0" || carInfo.isTransfercar == "">style="display:none"</#if>>
									<td></td>
									<td></td>
									<td>过户时间:</td>
									<td>
							...
							<table class="table table-bordered" style="margin-bottom:0px">
								<tr>
									...
									<td class="col-md-4">
                                        ...
                                        <!-- 车型vehicleId -->
                                        <input type="hidden" name="syvehicletypename" id="syvehicletypename" value="${Carmodelinfo.syvehicletypename}"/>
									...
									<td class="col-md-4">
										...
										-->
										<select name="isstandardcar" id="isstandardcar" style="WIDTH: 183px" class="form-control">
											<option value="1" <#if Carmodelinfo.isstandardcar == "1">selected="selected"</#if>>是</option> 
						     			    <option value="0" <#if Carmodelinfo.isstandardcar == "0">selected="selected"</#if>>否</option> 
										</select>
									</td>
								</tr>
								<tr>
